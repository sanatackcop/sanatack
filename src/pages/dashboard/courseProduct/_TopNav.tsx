...
export const NavigationPlayground: React.FC<navigationPlaygroundProps> = ({
  ...
  return (
    <>
      <nav className="sticky top-0 z-50 flex-shrink-0 bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm border-b border-gray-200 dark:border-gray-600 shadow-lg">
