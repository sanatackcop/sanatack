      ...
      <div>
        ...
        <div className="flex flex-col min-h-screen">
          ...
          <footer className="relative w-full bg-white  overflow-hidden">
            ...
            <div
              className="relative z-10 border-t border-white
             border-opacity-20 mt-20 flex flex-col
              sm:flex-row justify-between items-center gap-4 px-4 md:px-12 py-4  dark:border-[#333333]"
            >
