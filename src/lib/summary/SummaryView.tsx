  ...
  return (
    <div className="w-full min-w-0">
      <ScrollArea className="h-full">
        ...
        <div className="px-6 space-y-12 w-full min-w-0">
          ...
          {summary.payload.visuals?.photo_prompts &&
            summary.payload.visuals.photo_prompts.length > 0 && (
              <section className="relative">
                ...
                >
                  {summary.payload.visuals.photo_prompts.map((prompt, idx) => (
                    <div
                      key={`${prompt}-${idx}`}
          ...
          {summary.payload.visuals?.chart_ideas &&
            summary.payload.visuals.chart_ideas.length > 0 && (
              <section className="w-full max-w-full overflow-hidden min-w-0">
                ...
                <div className="space-y-12 w-full max-w-full overflow-hidden min-w-0">
                  {summary.payload.visuals.chart_ideas.map((idea, idx) => {
                    ...
                    return (
                      <div
                        key={`${idea.title}-${idx}`}
                        className="w-full max-w-full overflow-hidden min-w-0"
                      >
                        {idea.chart_type === "bar" && (
                          <BarChartComponent
                            title={idea.title}
