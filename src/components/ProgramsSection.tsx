...
export default function ProgramsSection() {
  ...
  return (
    <div
      className="bg-[#111111] border border-white border-opacity-20
          rounded-[70px] px-8 py-8 max-w-[85rem] mx-auto"
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 px-22 mb-6 pr-20 pl-20">
        {programs.map((program, i) => (
          <SpotlightCard
            key={i}
            className="!bg-black rounded-xl p-3 text-white shadow-sm border  py-6
          transform transition-transform duration-300 hover:scale-105 hover:border-opacity-50"
