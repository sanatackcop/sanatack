...
export class AddedCoursesLogic1744993675068 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "quiz" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "question" character varying NOT NULL, "options" jsonb NOT NULL, "correctAnswer" character varying NOT NULL, "explanation" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "lessonId" uuid, CONSTRAINT "PK_422d974e7217414e029b3e641d0" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "video_resource" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "youtubeId" character varying NOT NULL, "description" character varying, "duration" integer, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "lessonId" uuid, CONSTRAINT "PK_60cc887ccc69d83cf28c3dd850e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "lesson" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" character varying, "order" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_0ef25918f0237e68696dee455bd" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "lesson_mapper" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "order" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "module_id" uuid, "lesson_id" uuid, CONSTRAINT "PK_6498cf1374e85ff6b6998f1ac21" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "module" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, CONSTRAINT "PK_0e20d657f968b051e674fbe3117" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "course_mapper" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "order" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "course_id" uuid, "module_id" uuid, CONSTRAINT "PK_876a15993494364709b8953cae4" PRIMARY KEY ("id"))`);
