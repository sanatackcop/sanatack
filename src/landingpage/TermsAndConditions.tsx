        ...
        <section className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8 text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
            <p>
              ...
              govern your access to and use of the Sanatack platform, website,
              mobile app, and all related services (collectively, the
              &quot;Platform&quot;). By accessing or using Sanatack, you agree
            ...
            <section>
              ...
              <p>
                Sanatack is available to users of all ages. However, if you are
                under 18, you must use the Platform under the supervision of a
            ...
            <section>
              ...
              <p className="mt-2">
                ...
                violates these Terms or engages in fraudulent or abusive
                activity.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc ml-6 space-y-1">
                ...
                <li>
                  You are responsible for how you use the content provided by AI
                  tools.
                </li>
                <li>
                  Sanatack is not liable for errors, omissions, or any outcomes
                  resulting from reliance on AI outputs.
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p>
                Sanatack offers both free and paid plans. Payments are processed
                securely through Stripe, a third-party payment provider. By
                subscribing to a paid plan, you agree to Stripe’s payment terms
                and authorize recurring billing if applicable. We do not store
                or directly handle credit card information.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                All materials on Sanatack—including logos, designs, software,
                text, and course content—are owned by Sanatack or its licensors.
            ...
            <section>
              ...
              <p>
                By posting or uploading content (such as reviews, comments, or
                AI-generated inputs), you grant Sanatack a non-exclusive,
                worldwide, royalty-free license to use, display, and distribute
                that content for operational or promotional purposes.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Sanatack and its team shall not be held liable for any direct or
                indirect damages arising from use of the Platform, reliance on
                AI-generated information, or service interruptions or data loss.
            ...
            <section>
              ...
              <p>
                We may suspend or terminate access to your account at any time,
                with or without notice, for conduct that violates these Terms or
                harms the integrity of the Platform.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                We may update these Terms periodically. The latest version will
                always be posted on our website with a revised &quot;Last
                updated&quot; date.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                Arabia. Any disputes will be resolved under Saudi jurisdiction.
              </p>
            </section>
          ...
          >
            ...
            <p>
              ...
              تنظم هذه الشروط والأحكام (&quot;الشروط&quot;) استخدامك والوصول إلى
              منصة Sanatack وموقعها الإلكتروني وتطبيقها وجميع الخدمات المرتبطة
              بها (ويشار إليها مجتمعة بـ &quot;المنصة&quot;). باستخدامك لمنصة
              Sanatack، فإنك توافق على الالتزام بهذه الشروط. إذا كنت لا توافق
              على أي منها، فيرجى التوقف عن استخدام المنصة فورًا.
            </p>
            ...
            <section>
              ...
              <p>
                ...
                سن 18 عامًا، فيجب عليك استخدام المنصة تحت إشراف أحد الوالدين أو
                الوصي القانوني الذي يوافق على هذه الشروط.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mb-2">
                للوصول إلى بعض ميزات المنصة، يجب عليك إنشاء حساب. وتوافق على ما
                يلي:
              </p>
            ...
            <section>
              ...
              <p className="mb-2">
                ...
                مدعومة جزئيًا من خلال واجهة برمجة تطبيقات OpenAI. وتقر بما يلي:
              </p>
              <ul className="list-disc mr-6 space-y-1">
                <li>
                ...
                <li>
                  لا تتحمل Sanatack أي مسؤولية عن الأخطاء أو النتائج الناتجة عن
                  الاعتماد على هذه المخرجات.
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                بأمان من خلال خدمة Stripe، وهي مزود دفع تابع لطرف ثالث.
                وباشتراكك في خطة مدفوعة، فإنك توافق على شروط Stripe وتفوض عمليات
                الدفع المتكررة عند الاقتضاء. لا نقوم بتخزين أو معالجة بيانات
                بطاقات الدفع بشكل مباشر.
              </p>
            </section>

            <section>
              <h3 className="text-lg font-semibold mb-2">5. الملكية الفكرية</h3>
              <p>
                جميع المواد الموجودة على منصة Sanatack، بما في ذلك الشعارات،
                التصاميم، النصوص، البرامج، والمحتوى التعليمي، هي ملك لـ Sanatack
                أو مرخصة لها. يُحظر نسخ أو إعادة إنتاج أو توزيع أو تعديل أي جزء
                من المنصة دون إذن كتابي مسبق.
              </p>
            </section>

            <section>
              <h3 className="text-lg font-semibold mb-2">6. محتوى المستخدم</h3>
              <p>
            ...
            <section>
              <h3 className="text-lg font-semibold mb-2">8. حدود المسؤولية</h3>
              <p>
                لا تتحمل Sanatack أو فريقها أي مسؤولية عن أي أضرار مباشرة أو غير
                مباشرة ناتجة عن استخدام المنصة، أو الاعتماد على المعلومات
                الناتجة عن الذكاء الاصطناعي، أو انقطاع الخدمة أو فقدان البيانات.
            ...
            <section>
              ...
              <p>
                تخضع هذه الشروط لأحكام وأنظمة المملكة العربية السعودية. وتُحل أي
                نزاعات وفقًا للجهات القضائية المختصة في المملكة.
              </p>
            </section>
