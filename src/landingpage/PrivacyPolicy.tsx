        ...
        {language === "ar" ? (
          <section className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p>
                في Sanatack (&quot;نحن&quot; أو &quot;المنصة&quot;)، نحترم
                خصوصيتك ونسعى لحماية بياناتك الشخصية. توضح هذه &quot;سياسة
                الخصوصية&quot; كيفية جمعنا واستخدامنا وحمايتنا للمعلومات التي
                تزودنا بها عند استخدامك للمنصة، والموقع الإلكتروني، والخدمات
                المرتبطة بها (ويشار إليها مجتمعة بـ &quot;المنصة&quot;).
                باستخدامك لمنصة Sanatack، فإنك توافق على الممارسات الموضحة في
                هذه السياسة.
              </p>
              ...
              <section>
                ...
                <p className="mb-2">
                  عند إنشاء حساب أو استخدام خدماتنا، قد نقوم بجمع وتخزين
                  المعلومات التالية:
                </p>
                ...
                <p className="mt-2">
                  تتم معالجة المدفوعات الخاصة بالخطط المدفوعة عبر Moyasar، وهو
                  مزود دفع تابع لطرف ثالث وآمن. لا تقوم Sanatack بتخزين أو
                  الوصول إلى بيانات بطاقتك البنكية.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="mb-2">
                  تعتمد منصتنا على واجهة برمجة تطبيقات OpenAI لتوليد محتوى
                  تعليمي وتعلمي. عند استخدامك لميزات الذكاء الاصطناعي:
                </p>
                <ul className="list-disc mr-6 space-y-1">
                  <li>
                    قد يتم إرسال مدخلاتك (مثل الأسئلة أو النصوص) إلى خوادم
                    OpenAI لمعالجتها.
                  </li>
                  <li>
              ...
              <section>
                ...
                <p className="mb-2">
                  تتم جميع عمليات الدفع عبر Moyasar بشكل آمن. قد تقوم Moyasar
                  بجمع قدر محدود من المعلومات اللازمة لإتمام عملية الدفع، مثل
                  اسمك وبريدك الإلكتروني وبيانات وسيلة الدفع. لا تقوم Sanatack
                  بتخزين أو التحكم في هذه البيانات.
                </p>
                <p>
                  لمزيد من المعلومات، يمكنك مراجعة سياسة الخصوصية الخاصة بـ
                  Moyasar عبر الرابط:{" "}
                  <a
                    href="https://moyasar.com/en/resources/privacy-policy/"
                    target="_blank"
                    rel="noreferrer"
                    className="underline underline-offset-2"
                  >
                    https://moyasar.com/en/resources/privacy-policy/
                  </a>
                </p>
              </section>
              ...
              <section>
                ...
                <p className="mb-2">
                  قد نشارك قدرًا محدودًا من بياناتك مع مزودي خدمات موثوقين
                  لأغراض تشغيلية فقط، بما في ذلك:
                </p>
                <ul className="list-disc mr-6 space-y-1">
                  <li>OpenAI (لتوليد المحتوى المعتمد على الذكاء الاصطناعي)</li>
                  <li>Moyasar (لمعالجة عمليات الدفع)</li>
                </ul>
                <p className="mt-2">
              ...
              <section>
                ...
                <p className="mt-2">
                  يمكن للمستخدمين طلب حذف حساباتهم في أي وقت عن طريق التواصل
              ...
              <section>
                ...
                <ul className="list-disc mr-6 space-y-1">
                  ...
                  <li>
                    سحب الموافقة على المعالجة (إن كانت المعالجة مبنية على
                    موافقة)
                  </li>
                </ul>
                <p className="mt-2">
              ...
              <section>
                ...
                <p>
                  تم تصميم منصة Sanatack لتكون مناسبة لمختلف الأعمار، ولكن يجب
                  أن يستخدمها الأفراد دون سن 18 عامًا تحت إشراف أحد الوالدين أو
                  الوصي القانوني. لا نقوم بجمع بيانات شخصية من الأطفال عن عمد
          ...
          <section className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
            ...
            <div className="space-y-8 text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
              <p>
                At Sanatack (&quot;we,&quot; &quot;our,&quot; or
                &quot;us&quot;), your privacy is important to us. This Privacy
                Policy explains how we collect, use, and protect the information
                you provide when using our platform, website, and related
                services (collectively, the &quot;Platform&quot;). By using
                Sanatack, you agree to the practices described in this Privacy
                Policy.
              </p>
              ...
              <section>
                ...
                <p className="mt-2">
                  Payments for paid plans are processed through Moyasar, a
                  secure third-party payment provider. Sanatack does not store
              ...
              <section>
                ...
                <p className="mt-2">
                  We encourage users to avoid submitting confidential or
                  sensitive personal information when interacting with AI tools.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="mb-2">
                  All payments are securely processed through Moyasar. Moyasar
                  may collect limited information necessary to process payments,
                  such as your name, email, and payment method details. Sanatack
                  does not store or control this payment data.
                </p>
                <p>
                  For more information, please review Moyasar’s Privacy Policy:{" "}
                  <a
                    href="https://moyasar.com/en/resources/privacy-policy/"
                    target="_blank"
                    rel="noreferrer"
              ...
              <section>
                ...
                <p>
                  ...
                  destruction. Your account credentials are encrypted and
                  securely stored. While we strive to protect your information,
              ...
              <section>
                ...
                <ul className="list-disc ml-6 space-y-1">
                  ...
                  <li>Moyasar (for payment processing)</li>
                </ul>
                <p className="mt-2">
              ...
              <section>
                ...
                <p>
                  Sanatack is designed for all ages, but users under 18 should
                  use the platform under parental supervision. We do not
                  knowingly collect personal data from children without guardian
                  consent.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  ...
                  version will always be available on our website with an
